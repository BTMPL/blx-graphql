...
export type Employment = {
  ...
  annualIncomeBracket?: Maybe<Scalars['String']>;
  employerName?: Maybe<Scalars['String']>;
  employmentSector?: Maybe<EmploymentSector>;
...
export enum EmploymentSector {
  ...
  ACTIVITIES_OF_HOUSE = 'ACTIVITIES_OF_HOUSE',
  ...
  WHOLESALE_AND_RETAIL_TRADE_REPAIR_OF_MOTOR_VEHICLES_AND_MOTORCYCLES = 'WHOLESALE_AND_RETAIL_TRADE_REPAIR_OF_MOTOR_VEHICLES_AND_MOTORCYCLES'
}
...
export enum Occupation {
  ...
  ADMINISTRATION_PROFESSIONALS = 'ADMINISTRATION_PROFESSIONALS',
  ADMINISTRATIVE_AND_COMMERCIAL_MANAGERS = 'ADMINISTRATIVE_AND_COMMERCIAL_MANAGERS',
  ARMED_FORCES_OCCUPATIONS = 'ARMED_FORCES_OCCUPATIONS',
  BUSINESS_AND_ADMINISTRATIONS_ASSOCIATE_PROFESSIONALS = 'BUSINESS_AND_ADMINISTRATIONS_ASSOCIATE_PROFESSIONALS',
  CLERICAL_SUPPORT_WORKERS = 'CLERICAL_SUPPORT_WORKERS',
  CRAFT_AND_RELATED_TRADES_WORKERS = 'CRAFT_AND_RELATED_TRADES_WORKERS',
  DENTISTS = 'DENTISTS',
  ELEMENTARY_OCCUPATIONS = 'ELEMENTARY_OCCUPATIONS',
  FINANCIAL_ANALYSTS = 'FINANCIAL_ANALYSTS',
  FINANCIAL_AND_INVESTMENT_ADVISERS = 'FINANCIAL_AND_INVESTMENT_ADVISERS',
  HEALTH_ASSOCIATE_PROFESSIONALS = 'HEALTH_ASSOCIATE_PROFESSIONALS',
  HEALTH_PROFESSIONALS_NOT_ELSEWHERE_CLASSIFIED = 'HEALTH_PROFESSIONALS_NOT_ELSEWHERE_CLASSIFIED',
  HOSPITALITY_AND_RELATED_SERVICES_PROFESSIONALS = 'HOSPITALITY_AND_RELATED_SERVICES_PROFESSIONALS',
  HOSPITALITY_RETAIL_AND_OTHER_SERVICES_MANAGERS = 'HOSPITALITY_RETAIL_AND_OTHER_SERVICES_MANAGERS',
  HOUSEWIFE_HOUSEHUSBAND = 'HOUSEWIFE_HOUSEHUSBAND',
  INFORMATION_AND_COMMUNICATIONS_TECHNICIANS = 'INFORMATION_AND_COMMUNICATIONS_TECHNICIANS',
  INFORMATION_AND_COMMUNICATIONS_TECHNOLOGY_MANAGERS = 'INFORMATION_AND_COMMUNICATIONS_TECHNOLOGY_MANAGERS',
  INFORMATION_AND_COMMUNICATIONS_TECHNOLOGY_PROFESSIONALS = 'INFORMATION_AND_COMMUNICATIONS_TECHNOLOGY_PROFESSIONALS',
  INSURANCE_AGENT = 'INSURANCE_AGENT',
  JEWELLERY_AND_PRECIOUS_METAL_WORKERS = 'JEWELLERY_AND_PRECIOUS_METAL_WORKERS',
  JUDGES = 'JUDGES',
  LAWYERS = 'LAWYERS',
  LEGAL_ASSOCIATE_PROFESSIONALS = 'LEGAL_ASSOCIATE_PROFESSIONALS',
  LEGAL_PROFESSIONALS_NEC = 'LEGAL_PROFESSIONALS_NEC',
  LEGISLATORS_AND_SENIOR_OFFICIALS = 'LEGISLATORS_AND_SENIOR_OFFICIALS',
  MANAGING_DIRECTORS_AND_CHIEF_EXECUTIVES = 'MANAGING_DIRECTORS_AND_CHIEF_EXECUTIVES',
  MEDICAL_DOCTORS = 'MEDICAL_DOCTORS',
  NURSING_AND_MIDWIFERY_PROFESSIONALS = 'NURSING_AND_MIDWIFERY_PROFESSIONALS',
  OPTOMETRISTS_AND_OPHTHALMIC_OPTICIANS = 'OPTOMETRISTS_AND_OPHTHALMIC_OPTICIANS',
  OTHER_OUTSIDE_LABOUR_FORCE = 'OTHER_OUTSIDE_LABOUR_FORCE',
  PAWNBROKERS_AND_MONEY_LENDERS = 'PAWNBROKERS_AND_MONEY_LENDERS',
  PHARMACISTS = 'PHARMACISTS',
  PLANT_AND_MACHINE_OPERATORS_AND_ASSEMBLERS = 'PLANT_AND_MACHINE_OPERATORS_AND_ASSEMBLERS',
  PRODUCTION_AND_MANUFACTURING_MANAGERS = 'PRODUCTION_AND_MANUFACTURING_MANAGERS',
  REGULATORY_GOVERNMENT_ASSOCIATE_PROFESSIONALS = 'REGULATORY_GOVERNMENT_ASSOCIATE_PROFESSIONALS',
  REGULATORY_GOVERNMENT_PROFESSIONALS = 'REGULATORY_GOVERNMENT_PROFESSIONALS',
  RELIGIOUS_PROFESSIONALS = 'RELIGIOUS_PROFESSIONALS',
  RETIREE = 'RETIREE',
  SALES_MARKETING_AND_PUBLIC_RELATIONS_PROFESSIONALS = 'SALES_MARKETING_AND_PUBLIC_RELATIONS_PROFESSIONALS',
  SCIENCE_AND_ENGINEERING_ASSOCIATE_PROFESSIONALS = 'SCIENCE_AND_ENGINEERING_ASSOCIATE_PROFESSIONALS',
  SCIENCE_AND_ENGINEERING_PROFESSIONALS = 'SCIENCE_AND_ENGINEERING_PROFESSIONALS',
  SERVICES_MANAGERS = 'SERVICES_MANAGERS',
  SERVICE_AND_SALES_WORKERS = 'SERVICE_AND_SALES_WORKERS',
  SKILLED_AGRICULTURAL_FORESTRY_LIVESTOCK_AND_FISHERY_WORKERS = 'SKILLED_AGRICULTURAL_FORESTRY_LIVESTOCK_AND_FISHERY_WORKERS',
  SOCIAL_AND_CULTURAL_PROFESSIONALS = 'SOCIAL_AND_CULTURAL_PROFESSIONALS',
  SOCIAL_CULTURAL_AND_RELATED_ASSOCIATE_PROFESSIONALS = 'SOCIAL_CULTURAL_AND_RELATED_ASSOCIATE_PROFESSIONALS',
  STALL_AND_MARKET_SALESPERSONS = 'STALL_AND_MARKET_SALESPERSONS',
  STREET_FOOD_SALESPERSONS = 'STREET_FOOD_SALESPERSONS',
  STUDENT = 'STUDENT',
  TEACHING_PROFESSIONALS = 'TEACHING_PROFESSIONALS'
}
...
export type SaveEmploymentDataInput = {
  ...
  employmentSector?: InputMaybe<EmploymentSector>;
...
export type EmploymentResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Employment'] = ResolversParentTypes['Employment']> = {
  annualIncomeBracket?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  employerName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  employmentSector?: Resolver<Maybe<ResolversTypes['EmploymentSector']>, ParentType, ContextType>;
